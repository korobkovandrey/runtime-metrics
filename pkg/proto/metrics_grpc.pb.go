...
const (
	MetricsService_Update_FullMethodName  = "/runtime_metrics.MetricsService/Update"
	MetricsService_Updates_FullMethodName = "/runtime_metrics.MetricsService/Updates"
)
...
type MetricsServiceClient interface {
	Update(ctx context.Context, in *Metric, opts ...grpc.CallOption) (*Response, error)
	Updates(ctx context.Context, in *Metrics, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *metricsServiceClient) Update(ctx context.Context, in *Metric, opts ...grpc.CallOption) (*Response, error) {
...
func (c *metricsServiceClient) Updates(ctx context.Context, in *Metrics, opts ...grpc.CallOption) (*Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Response)
...
type MetricsServiceServer interface {
	Update(context.Context, *Metric) (*Response, error)
	Updates(context.Context, *Metrics) (*Response, error)
...
func (UnimplementedMetricsServiceServer) Update(context.Context, *Metric) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedMetricsServiceServer) Updates(context.Context, *Metrics) (*Response, error) {
...
func _MetricsService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServiceServer).Update(ctx, req.(*Metric))
	}
...
func _MetricsService_Updates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricsServiceServer).Updates(ctx, req.(*Metrics))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MetricsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "runtime_metrics.MetricsService",
